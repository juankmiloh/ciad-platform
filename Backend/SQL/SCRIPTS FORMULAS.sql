...
SELECT 
    ...
    CASE WHEN CAR_1674_ADD = 1 THEN CAR_1674_DT_UN_NT2 END AS C5,
    CASE WHEN CAR_1674_ADD = 1 THEN CAR_1674_DT_UN_NT3 END AS C6,
    CASE WHEN CAR_1674_ADD = 2 THEN CAR_1674_DT_UN_NT1 END AS C1,
    CASE WHEN CAR_1674_ADD = 2 THEN CAR_1674_DT_UN_NT2 END AS C5,
    CASE WHEN CAR_1674_ADD = 2 THEN CAR_1674_DT_UN_NT3 END AS C6,
    CASE WHEN CAR_1674_ADD = 3 THEN CAR_1674_DT_UN_NT1 END AS C1,
    CASE WHEN CAR_1674_ADD = 3 THEN CAR_1674_DT_UN_NT2 END AS C5,
    CASE WHEN CAR_1674_ADD = 3 THEN CAR_1674_DT_UN_NT3 END AS C6,
    CASE WHEN CAR_1674_ADD = 4 THEN CAR_1674_DT_UN_NT1 END AS C1,
    CASE WHEN CAR_1674_ADD = 4 THEN CAR_1674_DT_UN_NT2 END AS C5,
    CASE WHEN CAR_1674_ADD = 4 THEN CAR_1674_DT_UN_NT3 END AS C6
FROM ENERGIA_CREG_015.CAR_T1674_INFORMACION_ADD
WHERE CAR_CARG_ANO = 2020
AND CAR_CARG_PERIODO = 1
ORDER BY CAR_1674_ADD ASC;
...
AND A.CAR_1674_ADD = 4
AND A.CAR_CARG_ANO = 2020
AND A.CAR_CARG_PERIODO = 1
AND B.CAR_CARG_ANO = 2020
AND B.CAR_CARG_PERIODO = 1;
