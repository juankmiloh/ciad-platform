...
class gD097Resolucion(Resource):
    def __init__(self):
    ...
    def __execute_query(self):
        ...
        if self.__ANIO_ARG == 0:
            ...
            mydoc = self.connection.infoD097Res.find()
        else:
    ...
    def post(self):
        ...
        print("_________________________________")
        # Insertar datos
        self.connection.infoD097Res.insert_one(
            json.loads(req)
        )
        return req
    ...
    def put(self, anio=0):
        ...
        print("_________________________________")
        # Modificar datos
        self.connection.infoD097Res.update_one(
            {"anio": self.__ANIO_ARG},
    ...
    def delete(self, anio=0):
        ...
        print("_________________________________")
        # Borrar documento
        self.connection.infoD097Res.delete_one(
            {"anio": self.__ANIO_ARG}
        )
