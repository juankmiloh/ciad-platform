...
class rComponentT(Resource):
    ...
    def get(self, anio=0, mes=0, empresa=0, mercado=0, ntprop=""):
        ...
        componentService = ComponentService("T", self.__ANIO_ARG, self.__PERIODO_ARG, self.__EMPRESA_ARG, self.__MERCADO_ARG, self.__NTPROP_ARG)
    ...
    def post(self):
        ...
        self.connMDB.componentT.insert_one(
            json.loads(req)
        )
        return req
