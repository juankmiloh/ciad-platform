...
class CostoUnitarioService(CostoUnitario):
    ...
    def get_model_cu(self, dataCU):
        ...
        cpteC = pd.DataFrame(componenteC.get_values_component_SUI(), columns=['empresa','mercado','ano','mes','c6','c1','c7','c8','c9','c10','c11','c13','c20','c22','c24','c21','c14','c15','c16','c23','c25','c28','c29','c30','c31','c32','c36','c34','c33','c37','c35','c38','c59','c69','c70','c71','c58','c60','c44','c47','c48','c55','c56','c52','c53'])
        ...
        for result in dataCU:
            ...
            # --------------------- VALORES CPTE C --------------------- #
            modelC = self.get_values_cpteC(cpteC, result, self._CostoUnitario__ANIO_ARG, self._CostoUnitario__PERIODO_ARG, self._CostoUnitario__EMPRESA_ARG)
            # --------------------- VALORES CPTE CU --------------------- #
            # modelCU = self.get_values_cpteCU(modelG, modelT, modelP, modelD, modelR, result)
            ...
            componentes = [{'component_c': modelC}]
            valuesCU.append({
